 ...
 * @return U_COLLISION_FALSE if there is no collision. U_COLLISION_TRUE if the collision happened U_COLLISION_NOT_DETERMINED if the collision cannot be confirmed.
 ...
 * @warning Use u_collision_free_backout_cache to delete the returned backout cache.
