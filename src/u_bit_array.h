...
#define U_BIT_ARRAY_INDEX_AMOUNT(arraySize) (arraySize / U_BIT_ELEMENT_BIT_COUNT + (0 != (arraySize % U_BIT_ELEMENT_BIT_COUNT)))

#define U_BIT_ARRAY_SIZE(arraySize) (sizeof(u_bit_element) * U_BIT_ARRAY_INDEX_AMOUNT(arraySize))

#define U_BIT_ARRAY_GET(array, index) (\
    (array[index / U_BIT_ELEMENT_BIT_COUNT] >> (index % U_BIT_ELEMENT_BIT_COUNT)) & 1\
)
